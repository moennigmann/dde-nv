Models := module () export Agrawal1982, Disney2002, John1994, SOFC, 
Teymour1989b; Agrawal1982 := module () export CSTR, DimensionalCSTR; CSTR := 
module () local Sys; export getSys, getSolutions; Sys := table([("ExplicitAEs"
)=[k = 1, K = .12, a = 5.4, b = 180, M = -(x2-1)*exp(SF*x2/K), Sigma = M*(a+b*
SF)/(a-b*SF*x2+b*SF)],("DynVars")=[x1, x2],("AlgVars")=[],("AEs")=[],("ODEs")=
[`x1'` = -x1+M*Da*x1, `x2'` = -x2+Sigma*Da*x1],("Parameters")=[Da = .910365, 
SF = .3]]); getSys := proc () return eval(Sys) end proc; getSolutions := proc
() local Sol1, solutions; Sol1 := [x1 = .17747, x2 = .87753, Da = .910365, SF
= .3, k = 1., K = .12, a = 5.4, b = 180., M = 1.098489246, Sigma = 5.431465682
]; solutions := [Sol1]; return solutions end proc; end module; DimensionalCSTR
:= module () local Sys; export getSys, getSolutions; Sys := table([(
"ExplicitAEs")=[k = 1, K = .12, a = 5.4, b = 180, c1 = 5, V = 51.3*Pi, mu = k*
S*exp(-S/K), sigma = mu/(a+b*S), c2 = -70.3+270.3*SF],("DynVars")=[X, S],(
"AlgVars")=[],("AEs")=[],("ODEs")=[`X'` = -F/V*X+mu*X, `S'` = F/V*(SF-S)-sigma
*X],("Parameters")=[F = 3.0, SF = .3]]); getSys := proc () return eval(Sys) 
end proc; getSolutions := proc () local Sol1, Sol2, solutions; Sol1 := [F = 3,
SF = .3, X = 2.6201, S = .22443e-1, k = 1., K = .12, a = 5.4, b = 180., c1 = 5\
., V = 161.1637032, mu = .1861474040e-1, sigma = .1971954779e-2, c2 = 10.79];
Sol2 := [X = 4.22744, S = .7385282e-1, F = 6.432089, SF = .3, k = 1., K = .12,
a = 5.4, b = 180., c1 = 5., V = 161.1637032, mu = .3991028368e-1, sigma = .\
2134981007e-2, c2 = 10.79, w1_Hopf[1] = -.1102549550e-7, w1_Hopf[2] = -.\
4923686503e-1, w2_Hopf[1] = .9987871301, w2_Hopf[2] = -.2294538897e-6, 
omega_Hopf = .4330884089e-1]; solutions := [Sol1, Sol2]; return solutions end
proc; end module; end module; Disney2002 := module () export Sys; Sys := 
module () local Syst; export getSys; Syst := table([("DynEqns")=[VCON = VCON_t
, AVCON = AVCON_t, CONSt = CONSpar, CONSaux = CONSpar, VCONaux = VCON, 
ORATEaux1 = ORATE, ORATEaux2 = ORATEaux1, ORATEaux3 = ORATEaux2, COMRATE = 
COMRATE_t, ORATE = ORATE_t, AINV = AINV_t, R = R+1/(1+Tq)*(G*CONSpar-R)],(
"AlgEqns")=[],("DynVars")=[VCON, AVCON, CONSt, CONSaux, VCONaux, ORATEaux1, 
ORATEaux2, ORATEaux3, COMRATE, ORATE, AINV, R],("AlgVars")=[],(
...
8, G = 2, Tq = 4, Tpbar = 4, Ti = 4, Tw = 4]]); getSys := proc () return eval(
Syst) end proc; end module; end module; John1994 := module () export Sys; Sys
:= module () local Syst; export getSys, getFixPoint; Syst := table([("DynEqns"
)=[AINV = AINV_t, WIP = WIP_t, AVCON = AVCON_t],("AlgEqns")=[],("DynVars")=[
AINV, WIP, AVCON],("AlgVars")=[],("ExplicitAlgEqns")=[CONS_t = CONSpar, 
...
= 4, DINV = 50]]); getSys := proc () return eval(Syst) end proc; getFixPoint 
:= proc () local FP; FP := [Ti = 3., Ta = 1., Tw = 16., Tp = 3., Tpbar = 3., 
AINV = 1., DINV = 1., CONSpar = 1., AVCON = 1., WIP = 3.]; return FP end proc;
end module; end module; SOFC := module () export Reformer; Reformer := module
() local Sys; export getSys, getSol; Sys := table([("ExplicitAEs")=[r1 = .175e\
-1, r2 = .185e-1, r3 = .35e-1, r4 = .36e-1, dh_POX = 2*r3-2*r2, dh_NB = 2*r1,
rho_POXwand = 7900, rho_NBwand = 7900, C_POXwand = 477, C_NBwand = 477, Sigma
= .567e-7, Epsilon_NBwanda = .9, Epsilon_POXwand = .9, por = 1, LPOX = .15, 
A_NBwanda = 2*Pi*r2*LPOX, A_POXwand = 2*Pi*r3*LPOX, A_NBwandi = 2*Pi*r1*LPOX,
V_POX = LPOX*Pi*(r3^2-r2^2), V_NB = LPOX*Pi*r1^2, R = 8.31451, p0 = 101300, 
Mi_H2 = .2e-2, Mi_CO = .28e-1, Mi_C3H8 = .44e-1, Mi_CH4 = .16e-1, Mi_H2O = .18\
e-1, Mi_CO2 = .44e-1, Mi_N2 = .28e-1, Mi_O2 = .32e-1, C = r3/r2, B = (C^2-1)/
ln(C), D = 1+C^2-B, Nu_Corr = 8, Nu_NBwanda = Nu_Corr*D*(1-C)/C/(3/8+7/8*C^2-1
/2*B-1/2*C^4/B), Nu_POXwand = Nu_Corr*D*(1-C)/C/(1/2*B-7/8-3/8*C^2+1/2/B), 
Nu_NBwandi = 4.2*Nu_Corr, xi_POXLuftH2 = 0, xi_POXLuftCO = 0, xi_POXLuftC3H8 =
0, xi_POXLuftCH4 = 0, xi_POXLuftH2O = 0, xi_POXLuftCO2 = 0, xi_POXLuftN2 = .79
, xi_POXLuftO2 = .21, xi_POXeH2 = ni_POXeH2/(ni_POXeH2+ni_POXeCO+ni_POXeC3H8+
ni_POXeCH4+ni_POXeH2O+ni_POXeCO2+ni_POXeN2+ni_POXeO2), xi_POXeCO = ni_POXeCO/(
ni_POXeH2+ni_POXeCO+ni_POXeC3H8+ni_POXeCH4+ni_POXeH2O+ni_POXeCO2+ni_POXeN2+
ni_POXeO2), xi_POXeC3H8 = ni_POXeC3H8/(ni_POXeH2+ni_POXeCO+ni_POXeC3H8+
ni_POXeCH4+ni_POXeH2O+ni_POXeCO2+ni_POXeN2+ni_POXeO2), xi_POXeCH4 = ni_POXeCH4
/(ni_POXeH2+ni_POXeCO+ni_POXeC3H8+ni_POXeCH4+ni_POXeH2O+ni_POXeCO2+ni_POXeN2+
ni_POXeO2), xi_POXeH2O = ni_POXeH2O/(ni_POXeH2+ni_POXeCO+ni_POXeC3H8+
ni_POXeCH4+ni_POXeH2O+ni_POXeCO2+ni_POXeN2+ni_POXeO2), xi_POXeCO2 = ni_POXeCO2
/(ni_POXeH2+ni_POXeCO+ni_POXeC3H8+ni_POXeCH4+ni_POXeH2O+ni_POXeCO2+ni_POXeN2+
ni_POXeO2), xi_POXeN2 = ni_POXeN2/(ni_POXeH2+ni_POXeCO+ni_POXeC3H8+ni_POXeCH4+
ni_POXeH2O+ni_POXeCO2+ni_POXeN2+ni_POXeO2), xi_POXeO2 = ni_POXeO2/(ni_POXeH2+
ni_POXeCO+ni_POXeC3H8+ni_POXeCH4+ni_POXeH2O+ni_POXeCO2+ni_POXeN2+ni_POXeO2), 
xi_NBeH2 = xi_anaH2, xi_NBeCO = xi_anaCO, xi_NBeC3H8 = xi_anaC3H8, xi_NBeCH4 =
xi_anaCH4, xi_NBeH2O = xi_anaH2O, xi_NBeCO2 = xi_anaCO2, xi_NBeN2 = xi_anaN2,
xi_NBeO2 = xi_anaO2, xi_POXLuftH2 = 0, xi_POXLuftCO = 0, xi_POXLuftC3H8 = 0, 
xi_POXLuftCH4 = 0, xi_POXLuftH2O = 0, xi_POXLuftCO2 = 0, xi_POXLuftN2 = .79, 
xi_POXLuftO2 = .21, xi_NBe2H2 = xi_anaH2, xi_NBe2CO = xi_anaCO, xi_NBe2C3H8 =
xi_anaC3H8, xi_NBe2CH4 = xi_anaCH4, xi_NBe2H2O = xi_anaH2O, xi_NBe2CO2 = 
xi_anaCO2, xi_NBe2N2 = xi_anaN2, xi_NBe2O2 = xi_anaO2, ni_POXmH2 = ni_POXeH2+
ni_POXLuftH2, ni_POXmCO = ni_POXeCO+ni_POXLuftCO, ni_POXmC3H8 = ni_POXeC3H8+
ni_POXLuftC3H8, ni_POXmCH4 = ni_POXeCH4+ni_POXLuftCH4, ni_POXmH2O = ni_POXeH2O
+ni_POXLuftH2O, ni_POXmCO2 = ni_POXeCO2+ni_POXLuftCO2, ni_POXmN2 = ni_POXeN2+
ni_POXLuftN2, ni_POXmO2 = ni_POXeO2+ni_POXLuftO2, ni_NBmH2 = ni_NBeH2+
ni_NBe2H2, ni_NBmCO = ni_NBeCO+ni_NBe2CO, ni_NBmC3H8 = ni_NBeC3H8+ni_NBe2C3H8,
ni_NBmCH4 = ni_NBeCH4+ni_NBe2CH4, ni_NBmH2O = ni_NBeH2O+ni_NBe2H2O, ni_NBmCO2
= ni_NBeCO2+ni_NBe2CO2, ni_NBmN2 = ni_NBeN2+ni_NBe2N2, ni_NBmO2 = ni_NBeO2+
ni_NBe2O2, xi_POXmH2 = ni_POXmH2/(ni_POXmH2+ni_POXmCO+ni_POXmC3H8+ni_POXmCH4+
ni_POXmH2O+ni_POXmCO2+ni_POXmN2+ni_POXmO2), xi_POXmCO = ni_POXmCO/(ni_POXmH2+
ni_POXmCO+ni_POXmC3H8+ni_POXmCH4+ni_POXmH2O+ni_POXmCO2+ni_POXmN2+ni_POXmO2), 
xi_POXmC3H8 = ni_POXmC3H8/(ni_POXmH2+ni_POXmCO+ni_POXmC3H8+ni_POXmCH4+
ni_POXmH2O+ni_POXmCO2+ni_POXmN2+ni_POXmO2), xi_POXmCH4 = ni_POXmCH4/(ni_POXmH2
+ni_POXmCO+ni_POXmC3H8+ni_POXmCH4+ni_POXmH2O+ni_POXmCO2+ni_POXmN2+ni_POXmO2),
xi_POXmH2O = ni_POXmH2O/(ni_POXmH2+ni_POXmCO+ni_POXmC3H8+ni_POXmCH4+ni_POXmH2O
+ni_POXmCO2+ni_POXmN2+ni_POXmO2), xi_POXmCO2 = ni_POXmCO2/(ni_POXmH2+ni_POXmCO
...
Epsilon_NBwanda+1/A_POXwand*(1/Epsilon_POXwand-1))],("DynVars")=[T_POXa, T_NBa
, T_POXwand, T_NBwand],("AlgVars")=[xi_POXaH2, xi_POXaCO, xi_POXaCH4, 
xi_POXaH2O, xi_POXaCO2, xi_POXaN2],("AEs")=[0 = 1-xi_POXaC3H8-xi_POXaH2-
xi_POXaCO-xi_POXaCH4-xi_POXaH2O-xi_POXaCO2-xi_POXaN2-xi_POXaO2, 0 = (8*
xi_POXaC3H8+2*xi_POXaH2+4*xi_POXaCH4+2*xi_POXaH2O)/(8*xi_POXmC3H8+2*xi_POXmH2+
4*xi_POXmCH4+2*xi_POXmH2O)-(xi_POXaCO+xi_POXaH2O+2*xi_POXaCO2+2*xi_POXaO2)/(
xi_POXmCO+xi_POXmH2O+2*xi_POXmCO2+2*xi_POXmO2), 0 = ni_POXLuftN2+ni_POXeN2-
xi_POXaN2*n_POXa, 0 = (8*xi_POXaC3H8+2*xi_POXaH2+4*xi_POXaCH4+2*xi_POXaH2O)/(8
*xi_POXmC3H8+2*xi_POXmH2+4*xi_POXmCH4+2*xi_POXmH2O)-(3*xi_POXaC3H8+xi_POXaCO+
xi_POXaCH4+xi_POXaCO2)/(3*xi_POXmC3H8+xi_POXmCO+xi_POXmCH4+xi_POXmCO2), 0 = -(
G_H2+G_CO2-G_CO-G_H2O)/R/T_POXa-ln(xi_POXaH2*xi_POXaCO2/xi_POXaCO/xi_POXaH2O),
0 = -(3*G_H2+G_CO-G_CH4-G_H2O)/R/T_POXa-2*ln(p_POXa/p0)-ln(xi_POXaH2^3*p_POXa^
2/p0^2*xi_POXaCO/xi_POXaCH4/xi_POXaH2O)],("ODEs")=[`T_POXa'` = (ni_POXeH2*
h_POXeH2+ni_POXeCO*h_POXeCO+ni_POXeC3H8*h_POXeC3H8+ni_POXeCH4*h_POXeCH4+
ni_POXeH2O*h_POXeH2O+ni_POXeCO2*h_POXeCO2+ni_POXeN2*h_POXeN2+ni_POXeO2*
h_POXeO2+ni_POXLuftH2*h_POXLuftH2+ni_POXLuftCO*h_POXLuftCO+ni_POXLuftC3H8*
h_POXLuftC3H8+ni_POXLuftCH4*h_POXLuftCH4+ni_POXLuftH2O*h_POXLuftH2O+
ni_POXLuftCO2*h_POXLuftCO2+ni_POXLuftN2*h_POXLuftN2+ni_POXLuftO2*h_POXLuftO2-
ni_POXaH2*h_POXaH2-ni_POXaCO*h_POXaCO-ni_POXaC3H8*h_POXaC3H8-ni_POXaCH4*
h_POXaCH4-ni_POXaH2O*h_POXaH2O-ni_POXaCO2*h_POXaCO2-ni_POXaN2*h_POXaN2-
ni_POXaO2*h_POXaO2+Q_POXNB)/N_POX/Cp_POXa, `T_NBa'` = (-ni_NBaCO2*h_NBaCO2-
ni_NBaN2*h_NBaN2-ni_NBaO2*h_NBaO2+Q_NBwandi+ni_NBeH2*h_NBeH2+ni_NBeCO*h_NBeCO+
...
h_NBaC3H8-ni_NBaCH4*h_NBaCH4-ni_NBaH2O*h_NBaH2O)/N_NB/Cp_NBa, `T_POXwand'` = (
-Q_POXwand+Q_rad)/Pi/(r4^2-r3^2)/LPOX/rho_POXwand/C_POXwand/por, `T_NBwand'` =
-(Q_NBwanda+Q_NBwandi+Q_rad)/Pi/(r2^2-r1^2)/LPOX/rho_NBwand/C_NBwand/por],(
"Parameters")=[T_POXe = 738.5015100518901, p_POXe = 101300, ni_POXeH2 = .\
267847489961e-3, ni_POXeCO = .221582542707e-3, ni_POXeC3H8 = .37e-3, 
ni_POXeCH4 = .851480812e-6, ni_POXeH2O = .33390675461e-3, ni_POXeCO2 = .\
230158881127e-3, ni_POXeN2 = .425652850783e-3, ni_POXeO2 = 0, T_POXLuft = 298,
p_POXLuft = 101300, ni_POXLuftH2 = 0, ni_POXLuftCO = 0, ni_POXLuftC3H8 = 0, 
ni_POXLuftCH4 = 0, ni_POXLuftH2O = 0, ni_POXLuftCO2 = 0, ni_POXLuftN2 = .\
1043928571428e-2, ni_POXLuftO2 = .2775e-3, T_NBe = 1140.4504711677835, p_NBe =
101300, ni_NBeH2 = .328452691698e-3, ni_NBeCO = .271719487071e-3, ni_NBeC3H8 =
0, ni_NBeCH4 = .1044143309e-5, ni_NBeH2O = .409459025895e-3, ni_NBeCO2 = .\
282236372778e-3, ni_NBeN2 = .521964288667e-3, ni_NBeO2 = 0, T_NBLuft = 873, 
p_NBLuft = 101300, ni_NBLuftH2 = 0, ni_NBLuftCO = 0, ni_NBLuftC3H8 = 0, 
ni_NBLuftCH4 = 0, ni_NBLuftH2O = 0, ni_NBLuftCO2 = 0, ni_NBLuftN2 = .\
4175714285714e-2, ni_NBLuftO2 = .111e-2, T_NBe2 = 473, p_NBe2 = 101300, 
ni_NBe2H2 = 0, ni_NBe2CO = 0, ni_NBe2C3H8 = 0, ni_NBe2CH4 = 0, ni_NBe2H2O = 0,
ni_NBe2CO2 = 0, ni_NBe2N2 = 0, ni_NBe2O2 = 0, xi_anaH2 = .180978033757249, 
xi_anaCO = .149717934261691, xi_anaC3H8 = 0, xi_anaCH4 = .575324872657e-3, 
xi_anaH2O = .225612672034038, xi_anaCO2 = .155512757518103, xi_anaN2 = .287603\
277556262, xi_anaO2 = 0]]); getSys := proc () return eval(Sys) end proc; 
getSol := proc () return [xi_POXaH2 = .368750587510893, xi_POXaCO = .284790826\
986732, xi_POXaCH4 = .22337314596529e-1, xi_POXaH2O = .12042268644267e-1, 
xi_POXaCO2 = .11972472427902e-1, xi_POXaN2 = .300106529833676, T_POXa = 1026.5\
889711019772, T_NBa = 1166.1518337724226, T_POXwand = 1059.8353392024314, 
T_NBwand = 1076.2655452849394] end proc; end module; end module; Teymour1989b
:= module () export CSTR; CSTR := module () local Sys; export checkConsistency
, getSys, getSolutions; Sys := table([("ExplicitAEs")=[yf = 2/3, yref = 5/9, 
Tc = 45, T = 45*yT, negdeltaH = 21000, B = 1.4, alpha = 50/3, a3 = -.3495, a2
...
qoutoverqin = rhof/rhofT+theta*MWm*Rm*(1/rhop-1/rhom)],("Ranges")=[vm = 0 .. 1
, vs = 0 .. 1, zi = 0 .. 1, yT = 0 .. 10, theta = 0 .. 300, If = 0 .. .1],(
"DynVars")=[vm, vs, zi, yT],("AlgVars")=[],("AEs")=[],("ODEs")=[`vm'` = (1-
phis)*rhomf/rhom-vm*qoutoverqin-theta*vm*(lp+ltrm)*Q-2*theta*MWm/rhom*f*kd*zi*
If, `vs'` = phis*rhosf/rhos-vs*qoutoverqin, `zi'` = 1-theta*kd*zi-zi*
qoutoverqin, `yT'` = rhof*Cpf/rho/Cp*(yf-yref)-rhof/rho*(yT-yref)+negdeltaH/
rho/Cp/Tc*theta*vm*lp*rhom/MWm*Q-theta*alpha*B/rho/Cp*(yT-1)],("Parameters")=[
theta = 200.4617, If = .316531e-1, phis = .6]]); checkConsistency := proc () 
local Sol, Res, AbsRes, MaxAbsRes; Sol := getSolutions()[1]; Res := evalf(subs
(Sol,map(rhs,Sys["ODEs"]))); AbsRes := map(abs,Res); MaxAbsRes := max(op(
AbsRes)); if not MaxAbsRes < .10e-5 then error 
"error in ODEs larger than expected" end if; Res := evalf(subs(Sol,map(lhs-rhs
,Sys["ExplicitAEs"]))); AbsRes := map(abs,Res); MaxAbsRes := max(op(AbsRes));
if not MaxAbsRes < .10e-5 then error 
...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           > quit
memory used=4.5MB, alloc=3.8MB, time=0.13
