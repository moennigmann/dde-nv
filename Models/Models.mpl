...
module () local Sys; export getSys, getSolutions; Sys := table([("ODEs")=[
`x1'` = -x1+M*Da*x1, `x2'` = -x2+Sigma*Da*x1],("AEs")=[],("ExplicitAEs")=[k =
1, K = .12, a = 5.4, b = 180, M = -(x2-1)*exp(SF*x2/K), Sigma = M*(a+b*SF)/(a-
b*SF*x2+b*SF)],("Parameters")=[Da = .910365, SF = .3],("AlgVars")=[],(
"DynVars")=[x1, x2]]); getSys := proc () return eval(Sys) end proc; 
getSolutions := proc () local Sol1, solutions; Sol1 := [x1 = .17747, x2 = .877\
53, Da = .910365, SF = .3, k = 1., K = .12, a = 5.4, b = 180., M = 1.098489246
, Sigma = 5.431465682]; solutions := [Sol1]; return solutions end proc; end 
module; DimensionalCSTR := module () local Sys; export getSys, getSolutions; 
Sys := table([("ODEs")=[`X'` = -F/V*X+mu*X, `S'` = F/V*(SF-S)-sigma*X],("AEs")
=[],("ExplicitAEs")=[k = 1, K = .12, a = 5.4, b = 180, c1 = 5, V = 51.3*Pi, mu
= k*S*exp(-S/K), sigma = mu/(a+b*S), c2 = -70.3+270.3*SF],("Parameters")=[F =
3.0, SF = .3],("AlgVars")=[],("DynVars")=[X, S]]); getSys := proc () return 
eval(Sys) end proc; getSolutions := proc () local Sol1, Sol2, solutions; Sol1
:= [F = 3, SF = .3, X = 2.6201, S = .22443e-1, k = 1., K = .12, a = 5.4, b = 
180., c1 = 5., V = 161.1637032, mu = .1861474040e-1, sigma = .1971954779e-2, 
c2 = 10.79]; Sol2 := [X = 4.22744, S = .7385282e-1, F = 6.432089, SF = .3, k =
1., K = .12, a = 5.4, b = 180., c1 = 5., V = 161.1637032, mu = .3991028368e-1,
sigma = .2134981007e-2, c2 = 10.79, w1_Hopf[1] = -.1102549550e-7, w1_Hopf[2] =
...
module () local Syst; export getSys; Syst := table([("ExplicitAlgEqns")=[DINV
= 0, WIP = ORATE+ORATEaux1+ORATEaux2+ORATEaux3, VCON_t = CONSpar+VCON+1/(1+Tq)
*(G*CONSpar-VCON)-VCONaux-1/(1+Tq)*(G*CONSaux-VCONaux), AVCON_t = AVCON+1/(1+
Ta)*(VCON_t-AVCON), DWIPaux = AVCON*Tpbar, COMRATE_t = ORATEaux3, AINV_t = 
AINV+COMRATE_t-CONSpar, EINVaux = DINV-AINV, ORATE_t = AVCON+EINVaux/Ti+(
DWIPaux-WIP)/Tw],("AlgEqns")=[],("Parameters")=[CONSpar = 0, Ta = 8, G = 2, Tq
= 4, Tpbar = 4, Ti = 4, Tw = 4],("DynEqns")=[VCON = VCON_t, AVCON = AVCON_t, 
CONSt = CONSpar, CONSaux = CONSpar, VCONaux = VCON, ORATEaux1 = ORATE, 
ORATEaux2 = ORATEaux1, ORATEaux3 = ORATEaux2, COMRATE = COMRATE_t, ORATE = 
ORATE_t, AINV = AINV_t, R = R+1/(1+Tq)*(G*CONSpar-R)],("AlgVars")=[],(
"DynVars")=[VCON, AVCON, CONSt, CONSaux, VCONaux, ORATEaux1, ORATEaux2, 
ORATEaux3, COMRATE, ORATE, AINV, R]]); getSys := proc () return eval(Syst) end
proc; end module; end module; John1994 := module () export Sys; Sys := module
() local Syst; export getSys, getFixPoint; Syst := table([("ExplicitAlgEqns")=
[CONS_t = CONSpar, AVCON_t = AVCON+1/(1+Ta)*(CONS_t-AVCON), DWIPaux = AVCON*
Tpbar, EWIPaux = DWIPaux-WIP, EINVaux = DINV-AINV, ORATE_t = AVCON_t+EINVaux/
Ti+EWIPaux/Tw, WIP_t = Tp*(WIP+ORATE_t)/(1+Tp), COMRATE_t = WIP_t/Tp, AINV_t =
AINV+COMRATE_t-CONS_t],("AlgEqns")=[],("Parameters")=[CONSpar = 4, Ti = 16, Ta
= 16, Tw = 16, Tp = 4, Tpbar = 4, DINV = 50],("DynEqns")=[AINV = AINV_t, WIP =
WIP_t, AVCON = AVCON_t],("AlgVars")=[],("DynVars")=[AINV, WIP, AVCON]]); 
getSys := proc () return eval(Syst) end proc; getFixPoint := proc () local FP;
FP := [Ti = 3., Ta = 1., Tw = 16., Tp = 3., Tpbar = 3., AINV = 1., DINV = 1.,
CONSpar = 1., AVCON = 1., WIP = 3.]; return FP end proc; end module; end 
module; SOFC := module () export Reformer; Reformer := module () local Sys; 
export getSys, getSol; Sys := table([("ODEs")=[`T_POXa'` = (ni_POXLuftC3H8*
h_POXLuftC3H8+ni_POXeH2*h_POXeH2-ni_POXaO2*h_POXaO2-ni_POXaCO2*h_POXaCO2-
ni_POXaH2O*h_POXaH2O+ni_POXLuftH2*h_POXLuftH2+ni_POXLuftN2*h_POXLuftN2-
ni_POXaC3H8*h_POXaC3H8-ni_POXaCH4*h_POXaCH4+ni_POXLuftO2*h_POXLuftO2-ni_POXaN2
*h_POXaN2+ni_POXeO2*h_POXeO2+ni_POXLuftH2O*h_POXLuftH2O+ni_POXeCO2*h_POXeCO2+
ni_POXLuftCO*h_POXLuftCO+ni_POXeC3H8*h_POXeC3H8+ni_POXeCO*h_POXeCO+ni_POXeCH4*
h_POXeCH4+ni_POXeN2*h_POXeN2+ni_POXLuftCO2*h_POXLuftCO2-ni_POXaCO*h_POXaCO+
ni_POXeH2O*h_POXeH2O+ni_POXLuftCH4*h_POXLuftCH4-ni_POXaH2*h_POXaH2+Q_POXNB)/
N_POX/Cp_POXa, `T_NBa'` = (ni_NBe2N2*h_NBe2N2+ni_NBe2CH4*h_NBe2CH4+
ni_NBLuftCO2*h_NBLuftCO2+ni_NBLuftN2*h_NBLuftN2+ni_NBe2CO*h_NBe2CO+ni_NBe2H2*
h_NBe2H2+ni_NBeC3H8*h_NBeC3H8+ni_NBe2CO2*h_NBe2CO2+ni_NBLuftC3H8*h_NBLuftC3H8+
ni_NBLuftO2*h_NBLuftO2-ni_NBaCO*h_NBaCO-ni_NBaC3H8*h_NBaC3H8+ni_NBeH2O*
h_NBeH2O+ni_NBLuftCH4*h_NBLuftCH4-ni_NBaH2*h_NBaH2+ni_NBe2H2O*h_NBe2H2O+
ni_NBLuftCO*h_NBLuftCO-ni_NBaH2O*h_NBaH2O-ni_NBaCH4*h_NBaCH4+ni_NBLuftH2O*
h_NBLuftH2O-ni_NBaCO2*h_NBaCO2+ni_NBeN2*h_NBeN2+ni_NBeO2*h_NBeO2-ni_NBaN2*
h_NBaN2+ni_NBeH2*h_NBeH2+ni_NBLuftH2*h_NBLuftH2+Q_NBwandi+ni_NBeCH4*h_NBeCH4+
ni_NBeCO*h_NBeCO+ni_NBe2C3H8*h_NBe2C3H8+ni_NBe2O2*h_NBe2O2-ni_NBaO2*h_NBaO2+
ni_NBeCO2*h_NBeCO2)/N_NB/Cp_NBa, `T_POXwand'` = (-Q_POXwand+Q_rad)/Pi/(r4^2-r3
^2)/LPOX/rho_POXwand/C_POXwand/por, `T_NBwand'` = -(Q_NBwanda+Q_NBwandi+Q_rad)
/Pi/(r2^2-r1^2)/LPOX/rho_NBwand/C_NBwand/por],("AEs")=[0 = 1-xi_POXaC3H8-
xi_POXaH2-xi_POXaCO-xi_POXaCH4-xi_POXaH2O-xi_POXaCO2-xi_POXaN2-xi_POXaO2, 0 =
(8*xi_POXaC3H8+2*xi_POXaH2+4*xi_POXaCH4+2*xi_POXaH2O)/(8*xi_POXmC3H8+2*
xi_POXmH2+4*xi_POXmCH4+2*xi_POXmH2O)-(xi_POXaCO+xi_POXaH2O+2*xi_POXaCO2+2*
xi_POXaO2)/(xi_POXmCO+xi_POXmH2O+2*xi_POXmCO2+2*xi_POXmO2), 0 = ni_POXLuftN2+
ni_POXeN2-xi_POXaN2*n_POXa, 0 = (8*xi_POXaC3H8+2*xi_POXaH2+4*xi_POXaCH4+2*
xi_POXaH2O)/(8*xi_POXmC3H8+2*xi_POXmH2+4*xi_POXmCH4+2*xi_POXmH2O)-(3*
xi_POXaC3H8+xi_POXaCO+xi_POXaCH4+xi_POXaCO2)/(3*xi_POXmC3H8+xi_POXmCO+
...
T_NBa, T_POXwand, T_NBwand]]); getSys := proc () return eval(Sys) end proc; 
...
, getSys, getSolutions; Sys := table([("ODEs")=[`vm'` = (1-phis)*rhomf/rhom-vm
*qoutoverqin-theta*vm*(lp+ltrm)*Q-2*theta*MWm/rhom*f*kd*zi*If, `vs'` = phis*
rhosf/rhos-vs*qoutoverqin, `zi'` = 1-theta*kd*zi-zi*qoutoverqin, `yT'` = rhof*
Cpf/rho/Cp*(yf-yref)-rhof/rho*(yT-yref)+negdeltaH/rho/Cp/Tc*theta*vm*lp*rhom/
MWm*Q-theta*alpha*B/rho/Cp*(yT-1)],("AEs")=[],("ExplicitAEs")=[yf = 2/3, yref
= 5/9, Tc = 45, T = 45*yT, negdeltaH = 21000, B = 1.4, alpha = 50/3, a3 = -.34\
95, a2 = -6.7530, a1 = -.4407, f = .8, R = 1.987, MWs = 74.10, MWm = 86.05, 
phim = 1-phis, rhosf = 777.2814025, rhomf = 918.5720, rhomg = 892.0200, rhof =
rhomf*phim+rhosf*phis, rhos = 74120/(91.878+.116*T), rhop = 1211-.8496*T, rhom
= 958.4-1.3276*T, rhofT = rhom*phim+rhos*phis, vp = 1-vm-vs, rho = rhom*vm+
rhos*vs+rhop*vp, kd = exp(ln(60)+34.99620124-30800/R/(T+273)), xt = (rhomf*
phim-vm*rhomg)/(rhomf*phim+MWm/MWs*phis*rhosf), lt = exp(a1*xt+a2*xt^2+a3*xt^3
), ltrm = 417.3948000*exp(-7569./R/(T+273.)), lp = 979.8*exp(-4869/R/(T+273))*
15^(1/2), Cpf = (.470*rhomf*phim+.716*rhosf*phis)/(rhomf*phim+rhosf*phis), Cp
= (.470*rhom*vm+.716*rhos*vs+rhop*vp*(.321425+.955e-3*T))/(rhom*vm+rhos*vs+
rhop*vp), Q = 2^(1/2)*(f*kd*zi*If/lt)^(1/2), Rm = (lp+ltrm)*Q*rhom/MWm*vm+2*f*
kd*zi*If, qoutoverqin = rhof/rhofT+theta*MWm*Rm*(1/rhop-1/rhom)],("Parameters"
)=[theta = 200.4617, If = .316531e-1, phis = .6],("Ranges")=[vm = 0 .. 1, vs =
0 .. 1, zi = 0 .. 1, yT = 0 .. 10, theta = 0 .. 300, If = 0 .. .1],("AlgVars")
=[],("DynVars")=[vm, vs, zi, yT]]); checkConsistency := proc () local Sol, Res
, AbsRes, MaxAbsRes; Sol := getSolutions()[1]; Res := evalf(subs(Sol,map(rhs,
Sys["ODEs"]))); AbsRes := map(abs,Res); MaxAbsRes := max(op(AbsRes)); if not 
MaxAbsRes < .10e-5 then error "error in ODEs larger than expected" end if; Res
:= evalf(subs(Sol,map(lhs-rhs,Sys["ExplicitAEs"]))); AbsRes := map(abs,Res); 
MaxAbsRes := max(op(AbsRes)); if not MaxAbsRes < .10e-5 then error 
...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  > quit
memory used=3.4MB, alloc=2.9MB, time=0.06
