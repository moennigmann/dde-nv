...
1000    continue
        ...
        c(8) = x(8)*x(5)+x(9)*x(6)+x(10)*x(7)-1.D0
     ...
     #X(3,2,3)*x(6)+FXX(3,3,3)*x(7))
        c(12) = F0(1)*x(12)+F0(2)*x(13)+F0(3)*x(14)+x(8)*(J0(1,1)*x(5)+J
     #0(1,2)*x(6)+J0(1,3)*x(7))+x(9)*(J0(2,1)*x(5)+J0(2,2)*x(6)+J0(2,3)*
     #x(7))+x(10)*(J0(3,1)*x(5)+J0(3,2)*x(6)+J0(3,3)*x(7))
