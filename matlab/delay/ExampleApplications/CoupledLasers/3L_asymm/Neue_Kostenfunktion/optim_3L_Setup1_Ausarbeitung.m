...
param=[0.199943165310036;0.143042379378885;0.143042379378884];
...
%J=@(x)-1e6*abs((x(4)+1i*x(5))+(x(7)+1i*x(8))); %Maximale Intensität (mit p1=p2=0.1)

J=@(x)-1e2*(abs((x(4)+1i*x(5))+2*(x(7)+1i*x(8))))/(x(10)+x(11)+x(12));
...
aDDENLP=DDENLP(J,aDDE_3L,xNom,[-Inf;-Inf;-Inf;-Inf;-Inf;-Inf;-Inf;-Inf;-Inf],[Inf;Inf;Inf;Inf;Inf;Inf;Inf;Inf;Inf],[0;0;0],[0.5;Inf;Inf],[-Inf],[Inf]);
% clear aDDE_1L
% clear J
% clear xNom
...
%aDDENLP.optionsMainOptim=optimoptions('fmincon','Algorithm','interior-point','MaxIter',10000,'MaxFunEvals',200000,'display','iter','TolFun',1e-6,'TolX',1e-7,'ScaleProblem','none');
%active-set
...
openfig('p1_p2_neu.fig')
openfig('p2_p3_neu.fig')
...
plot(aDDENLP.vars.critical(4,1).alpha.values(1),aDDENLP.vars.critical(4,1).alpha.values(2),'rs')

figure(2)
hold on
plot(aDDENLP.vars.critical(1,1).alpha.values(2),aDDENLP.vars.critical(1,1).alpha.values(3),'rs')
plot(aDDENLP.vars.critical(2,1).alpha.values(2),aDDENLP.vars.critical(2,1).alpha.values(3),'rs')
plot(aDDENLP.vars.critical(3,1).alpha.values(2),aDDENLP.vars.critical(3,1).alpha.values(3),'rs')
plot(aDDENLP.vars.critical(4,1).alpha.values(2),aDDENLP.vars.critical(4,1).alpha.values(3),'rs')


figure(1)
hold on
quiver(aDDENLP.vars.critical(2,1).alpha.values(1),aDDENLP.vars.critical(2,1).alpha.values(2),0.05*aDDENLP.vars.critical(2,1).r.values(1),0.05*aDDENLP.vars.critical(2,1).r.values(2))
quiver(aDDENLP.vars.critical(3,1).alpha.values(1),aDDENLP.vars.critical(3,1).alpha.values(2),0.5*aDDENLP.vars.critical(3,1).r.values(1),0.5*aDDENLP.vars.critical(3,1).r.values(2))
quiver(aDDENLP.vars.critical(1,1).alpha.values(1),aDDENLP.vars.critical(1,1).alpha.values(2),0.05*aDDENLP.vars.critical(1,1).r.values(1),0.05*aDDENLP.vars.critical(1,1).r.values(2))
quiver(aDDENLP.vars.critical(4,1).alpha.values(1),aDDENLP.vars.critical(4,1).alpha.values(2),0.5*aDDENLP.vars.critical(4,1).r.values(1),0.5*aDDENLP.vars.critical(4,1).r.values(2))

figure(2)
hold on
quiver(aDDENLP.vars.critical(1,1).alpha.values(2),aDDENLP.vars.critical(1,1).alpha.values(3),0.055*aDDENLP.vars.critical(1,1).r.values(2),0.055*aDDENLP.vars.critical(1,1).r.values(3))
quiver(aDDENLP.vars.critical(4,1).alpha.values(2),aDDENLP.vars.critical(4,1).alpha.values(3),0.35*aDDENLP.vars.critical(4,1).r.values(2),0.35*aDDENLP.vars.critical(4,1).r.values(3))
quiver(aDDENLP.vars.critical(2,1).alpha.values(2),aDDENLP.vars.critical(2,1).alpha.values(3),0.055*aDDENLP.vars.critical(2,1).r.values(2),0.055*aDDENLP.vars.critical(2,1).r.values(3))
quiver(aDDENLP.vars.critical(3,1).alpha.values(2),aDDENLP.vars.critical(3,1).alpha.values(3),0.35*aDDENLP.vars.critical(3,1).r.values(2),0.35*aDDENLP.vars.critical(3,1).r.values(3))
...
%% run optimization
aDDENLP.maxAllowedRealPart=-0.01;
...
figure(1)
hold on
quiver(aDDENLP.vars.critical(2,1).alpha.values(1),aDDENLP.vars.critical(2,1).alpha.values(2),0.02*aDDENLP.vars.critical(2,1).r.values(1),0.02*aDDENLP.vars.critical(2,1).r.values(2))
quiver(aDDENLP.vars.critical(3,1).alpha.values(1),aDDENLP.vars.critical(3,1).alpha.values(2),7.5*aDDENLP.vars.critical(3,1).r.values(1),7.5*aDDENLP.vars.critical(3,1).r.values(2))
quiver(aDDENLP.vars.critical(1,1).alpha.values(1),aDDENLP.vars.critical(1,1).alpha.values(2),0.02*aDDENLP.vars.critical(1,1).r.values(1),0.02*aDDENLP.vars.critical(1,1).r.values(2))
quiver(aDDENLP.vars.critical(4,1).alpha.values(1),aDDENLP.vars.critical(4,1).alpha.values(2),7.5*aDDENLP.vars.critical(4,1).r.values(1),7.5*aDDENLP.vars.critical(4,1).r.values(2))


figure(2)
hold on
quiver(aDDENLP.vars.critical(1,1).alpha.values(2),aDDENLP.vars.critical(1,1).alpha.values(3),0.02*aDDENLP.vars.critical(1,1).r.values(2),0.02*aDDENLP.vars.critical(1,1).r.values(3))
quiver(aDDENLP.vars.critical(2,1).alpha.values(2),aDDENLP.vars.critical(2,1).alpha.values(3),0.02*aDDENLP.vars.critical(2,1).r.values(2),0.02*aDDENLP.vars.critical(2,1).r.values(3))
quiver(aDDENLP.vars.critical(3,1).alpha.values(2),aDDENLP.vars.critical(3,1).alpha.values(3),7.5*aDDENLP.vars.critical(3,1).r.values(2),7.5*aDDENLP.vars.critical(3,1).r.values(3))
quiver(aDDENLP.vars.critical(4,1).alpha.values(2),aDDENLP.vars.critical(4,1).alpha.values(3),7.5*aDDENLP.vars.critical(4,1).r.values(2),7.5*aDDENLP.vars.critical(4,1).r.values(3))
