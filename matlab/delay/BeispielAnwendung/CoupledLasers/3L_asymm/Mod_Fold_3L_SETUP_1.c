  ...
  double residuum[19])
{
  ...
  residuum[9] = -0.5525854590e1 * cos(0.2e1 + 0.100e3 * p[0]) * w[0] - 0.5525854590e1 * sin(0.2e1 + 0.100e3 * p[0]) * w[1] - 0.5000e3 * x[2] * w[0] - (0.1000e4 * p[0] - 0.20000e4 * x[2]) * w[1] - (0.5000e3 * x[0] - 0.20000e4 * x[1]) * w[2] - 0.1e1 * w[0];
  residuum[10] = 0.5525854590e1 * sin(0.2e1 + 0.100e3 * p[0]) * w[0] - 0.5525854590e1 * cos(0.2e1 + 0.100e3 * p[0]) * w[1] - (-0.1000e4 * p[0] + 0.20000e4 * x[2]) * w[0] - 0.5000e3 * x[2] * w[1] - (0.20000e4 * x[0] + 0.5000e3 * x[1]) * w[2] - 0.1e1 * w[1];
  residuum[11] = 0.10000e2 * (x[2] + 0.1e1) * x[0] * w[0] + 0.10000e2 * (x[2] + 0.1e1) * x[1] * w[1] - (-0.5000e1 - 0.5000e1 * pow(x[0], 0.2e1) - 0.5000e1 * pow(x[1], 0.2e1)) * w[2] - 0.1e1 * w[2];
  residuum[12] = -0.5525854590e1 * cos(0.2e1 + 0.100e3 * p[0]) * w[0] - 0.5525854590e1 * sin(0.2e1 + 0.100e3 * p[0]) * w[1] - 0.5000e3 * x[5] * w[3] - (0.1000e4 * p[0] - 0.20000e4 * x[5]) * w[4] - (0.5000e3 * x[3] - 0.20000e4 * x[4]) * w[5] - 0.1e1 * w[3];
  residuum[13] = 0.5525854590e1 * sin(0.2e1 + 0.100e3 * p[0]) * w[0] - 0.5525854590e1 * cos(0.2e1 + 0.100e3 * p[0]) * w[1] - (-0.1000e4 * p[0] + 0.20000e4 * x[5]) * w[3] - 0.5000e3 * x[5] * w[4] - (0.20000e4 * x[3] + 0.5000e3 * x[4]) * w[5] - 0.1e1 * w[4];
  residuum[14] = 0.10000e2 * (x[5] + 0.1e1) * x[3] * w[3] + 0.10000e2 * (x[5] + 0.1e1) * x[4] * w[4] - (-0.5000e1 - 0.5000e1 * pow(x[3], 0.2e1) - 0.5000e1 * pow(x[4], 0.2e1)) * w[5] - 0.1e1 * w[5];
  residuum[15] = -0.5525854590e1 * cos(0.2e1 + 0.100e3 * p[0]) * w[0] - 0.5525854590e1 * sin(0.2e1 + 0.100e3 * p[0]) * w[1] - 0.5000e3 * x[8] * w[6] - (0.1000e4 * p[0] - 0.20000e4 * x[8]) * w[7] - (0.5000e3 * x[6] - 0.20000e4 * x[7]) * w[8] - 0.1e1 * w[6];
  residuum[16] = 0.5525854590e1 * sin(0.2e1 + 0.100e3 * p[0]) * w[0] - 0.5525854590e1 * cos(0.2e1 + 0.100e3 * p[0]) * w[1] - (-0.1000e4 * p[0] + 0.20000e4 * x[8]) * w[6] - 0.5000e3 * x[8] * w[7] - (0.20000e4 * x[6] + 0.5000e3 * x[7]) * w[8] - 0.1e1 * w[7];
  residuum[17] = 0.10000e2 * (x[8] + 0.1e1) * x[6] * w[6] + 0.10000e2 * (x[8] + 0.1e1) * x[7] * w[7] - (-0.5000e1 - 0.5000e1 * pow(x[6], 0.2e1) - 0.5000e1 * pow(x[7], 0.2e1)) * w[8] - 0.1e1 * w[8];
