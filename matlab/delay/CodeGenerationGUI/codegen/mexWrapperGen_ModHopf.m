...
fileID = fopen('modhopf_Manifold.c','w');
fprintf(fileID,'#include "mex.h"\n');
addID = fopen('ModHopfManifold.c','r'); 
...
fprintf(fileID,' ManifoldEquation(xPointer,alphaPointer,pPointer,omega,w1Pointer,w2Pointer,residuumPointer);\n');
fprintf(fileID,'}\n');
