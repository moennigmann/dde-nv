...
/***********************************************************/
	...
	fd = fopen("olsen#DResult.txt", "w");
	Array2DB_init(&olsen3D_DataMatrix, nipt, olsen3D_columns());
...
/***********************************************************/
	...
	dp_tides(olsen3D, nvar, npar, nfun, v, p, 
			lt, nipt, tolrel, tolabs, olsen3D_DataMatrix, fd);
	...
	{
		outvals[counter]= olsen3D_DataMatrix[1][counter];
	}
